...
\AtBeginSubsection[]
{
	\begin{frame}{\,}{\thesection \, \secname}
		...
		\centering\textsl{\textbf{\textcolor{sesarblue}{
					\LARGE \subsecname
				}}}
	\end{frame}
}
...
% colored textbf
\newcommand{\ctextbf}[1]{\textbf{\textcolor{sesarblue}{#1}}}
\newcommand{\btextbf}[1]{\textbf{\textcolor{airforceblue}{#1}}}

% colored textsl
\newcommand{\ctextsl}[1]{\textsl{\textcolor{sesarblue}{#1}}}
\newcommand{\btextsl}[1]{\textsl{\textcolor{airforceblue}{#1}}}

% colored emph
\newcommand{\cemph}[1]{\emph{\textcolor{sesarblue}{#1}}}
