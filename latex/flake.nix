  ...
  outputs = inputs: inputs.flake-parts.lib.mkFlake { inherit inputs; } {
    ...
    perSystem =
      ...
      in
      {
        ...
        packages =
          let
            pdf_builder = { src ? inputs.gitignore.lib.gitignoreSource ./., makeglossaries ? true, tex_file }:
              let
          ...
          rec {
            inherit texScheme;
            default = release;
            document = pdf_builder { tex_file = "main"; src = inputs.gitignore.lib.gitignoreSource ./.; };
